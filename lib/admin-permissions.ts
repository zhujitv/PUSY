...
export const adminActionPermissions: Record<string, AdminPermission> = {
  ...
  "create-product-category": "products.manage",
  "update-product-category": "products.manage",
  "delete-product-category": "products.manage",
  "update-order-status": "orders.fulfill",
  "bulk-update-order-status": "orders.fulfill",
  "ship-order": "orders.fulfill",
  "add-shipment-event": "orders.fulfill",
  "cancel-order": "orders.manage",
  "update-member-status": "customers.manage",
  "update-subscriber-status": "marketing.manage",
  "update-return-status": "support.manage",
  "update-return-logistics": "support.manage",
  "approve-return-refund": "finance.manage",
  ...
  "save-content-draft": "content.manage",
  ...
  "create-community-campaign": "community.manage",
  "update-community-creator": "community.manage",
  "qualify-community-campaign-entry": "community.manage",
  "bulk-update-community-post-status": "community.manage",
  "update-community-comment-status": "community.manage",
  "save-community-topic": "community.manage",
  "update-community-campaign-status": "community.manage",
  "save-community-campaign": "community.manage",
  "update-community-member-governance": "community.manage",
  "send-community-broadcast": "community.manage",
