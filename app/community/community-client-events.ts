export type CommunityClientEventType = "post_impression" | "product_click" | "add_to_cart";

export function recordCommunityEvent(eventType: CommunityClientEventType, postId: string, productSlug?: string, stableKey?: string) {
  ...
  const body = JSON.stringify({ eventKey: crypto.randomUUID(), eventType, postId, productSlug });
