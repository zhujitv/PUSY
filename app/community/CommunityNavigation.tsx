...
export function CommunityNavigation({ active, viewerPublicId, unreadCount = 0 }: { active: "home" | "publish" | "profile" | "notifications" | "creator"; viewerPublicId?: string; unreadCount?: number }) {
  ...
  return <>
    ...
    <nav className="community-subnav" aria-label="社区导航">
      ...
      <aside><a className={active === "creator" ? "active" : ""} href="/community/creator">创作中心</a><a className={active === "publish" ? "active primary" : "primary"} href="/community/publish"><CommunityIcon name="pen" size={16} />发布</a><a className={active === "profile" ? "active" : ""} href={profileHref}>我的主页</a></aside>
    </nav>
