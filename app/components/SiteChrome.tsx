...
export function SiteHeader({ cartCount = 0 }: { cartCount?: number }) {
  ...
  return <>
    ...
    <header className="site-header">
      ...
      <div className="header-actions"><a className="text-action" href="/catalog/products">搜索</a><a className="bag-button" href="/catalog/products" aria-label={`购物袋，${cartCount} 件商品`}>购物袋 <b>{cartCount}</b></a></div>
    </header>
...
export function SiteFooter() {
  return <>
    <section className="newsletter compact-newsletter"><div><p>PÚSY CLUB</p><h2>订阅邮件，立享 9 折</h2></div><form><input aria-label="电子邮箱" type="email" placeholder="电子邮箱" /><button type="button">订阅 →</button></form></section>
    <footer>
      ...
      <div className="footer-contact"><a href="tel:+79266740938">+7 (926) 674-09-38</a><a href="mailto:help@pusy.beauty">help@pusy.beauty</a><span>© PÚSY 2026</span></div>
    </footer>
  </>;
}
