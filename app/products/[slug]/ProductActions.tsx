...
export function ProductActions({ product, sourceCommunityPostId }: { product: Product; sourceCommunityPostId?: string }) {
  ...
  function runPrimaryAction() { if (purchasable) { addToCart(product, count); if (sourceCommunityPostId) recordCommunityEvent("add_to_cart", sourceCommunityPostId, product.slug); } else void toggleAlert("restock"); }
