...
export default function DetailsPage() {
  return <InfoPage eyebrow="中国经营信息" title="经营者信息" intro="本页用于公示 PUSY.CN 中国电子商务经营主体、联系方式与网站备案信息。">
    ...
    <h2>客户服务与消费争议</h2>
    <p>客服电话：{chinaRegion.customerServicePhone}</p><p>客服邮箱：<a href={`mailto:${chinaRegion.supportEmail}`}>{chinaRegion.supportEmail}</a></p><p>如与我们协商后争议仍未解决，消费者可依法通过全国12315平台或有管辖权的市场监督管理部门寻求帮助。</p>
    <h2>网站备案</h2>
